...
get_tpm_nlinks_per_cluster <- function(cell_types, pred_path, threshold) {
...
#make_filtered_table(res, lim_cell_types =  8, lim_dist = 20000, lim_e2g_rank = 2, out_dir = out_dir)
