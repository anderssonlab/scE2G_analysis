...
## files
# for qc
out_dir <- "/oak/stanford/groups/engreitz/Users/sheth/scE2G_analysis/2025_0127_validation_cell_lines/HCT116_processing"; dir.create(out_dir, showWarnings = FALSE)
# for saving per-cluster files
final_out_dir <-  "/oak/stanford/groups/engreitz/Users/sheth/scE2G_analysis/2025_0127_validation_cell_lines/scE2G_input"; dir.create(final_out_dir, showWarnings = FALSE)


fragment_path <- file.path(out_dir, "combined_atac_fragments.tsv.gz")
fragment_list <-c(e18l1 = "/oak/stanford/projects/igvf/Projects/250218_shared/e18l1_fragments.tsv.gz",
	e18l2 = "/oak/stanford/projects/igvf/Projects/250218_shared/e18l2_fragments.tsv.gz",
	e18l3 = "/oak/stanford/projects/igvf/Projects/250218_shared/e18l3_fragments.tsv.gz",
	e18l4 = "/oak/stanford/projects/igvf/Projects/250218_shared/e18l4_fragments.tsv.gz")
seu_path <- "/oak/stanford/groups/engreitz/Users/sheth/scE2G_analysis/2025_0127_validation_cell_lines/data/seu_e18_hct116.Robj"
seu_out <- file.path(out_dir, "seu_HCT116.rds")
meta_path <-  file.path(out_dir, "seu_HCT116_metadata.tsv.gz")
